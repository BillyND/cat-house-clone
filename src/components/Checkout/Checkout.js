          ...
          <form className="needs-validation">
            <div className="row">
              <div className="form-group col-md-6 mb-3">
                ...
                <input
                  ...
                  id="inputName"
                  placeholder={`${userLogin.name ? "" : "Họ và tên"}`}
                  required
                  value={name}
                  ref={nameRef}
              ...
              <div className="form-group col-md-6 mb-3">
                ...
                <input
                  ...
                  className="form-control"
                  id="inputPhone"
                  placeholder={`${userLogin.name ? "" : "Số điện thoại"}`}
                  value={phone}
                  ref={phoneRef}
            ...
            <div className="form-group mb-3">
              ...
              <input
                ...
                className="form-control"
                id="inputEmail"
                placeholder={`${userLogin.name ? "" : "Email"}`}
                value={email}
            ...
            <div className="row">
              ...
              <div className="form-group mb-3">
                ...
                <input
                  ...
                  className="form-control"
                  id="inputAddress"
                  placeholder={`${userLogin.name ? "" : "Địa chỉ"}`}
                  value={address}
            ...
            <div className="form-check mb-3">
              ...
              <label className="form-check-label">Thanh Toán MoMo</label>
            </div>
            <div className="form-check mb-3">
              <input
            ...
            <div className="form-check mb-3">
              <input className="form-check-input" type="radio" disabled />
              <label className="form-check-label">Ví điện tử ZaloPay</label>
            </div>
            <div className="form-check mb-3">
              <input className="form-check-input" type="radio" disabled />
              <label className="form-check-label">Ví ShopeePay</label>
            </div>
            <div className="form-check mb-3">
              <input className="form-check-input" type="radio" disabled />
              <label className="form-check-label">
                Thẻ ATM / Internet Banking / Thẻ tín dụng (Credit card) / Thẻ
                ghi nợ (Debit card) / VNPay QR
              </label>
            </div>
            <div className="form-check mb-3">
              <input className="form-check-input" type="radio" disabled />
              <label className="form-check-label">VNPay QR</label>
            </div>
            <button
              type="button"
              onClick={() => handleOrder()}
